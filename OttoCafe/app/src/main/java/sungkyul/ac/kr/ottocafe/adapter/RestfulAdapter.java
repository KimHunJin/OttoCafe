...
public class RestfulAdapter {
    ...
    private static ConnectService Interface;

    public synchronized static ConnectService getInstance() {
        if (Interface == null) {
            //통신로그를 확인하기 위한 부분
            ...
            Interface = new Retrofit.Builder()
                    ...
                    .build().create(ConnectService.class); //인터페이스 연결
        }
        return Interface;
    }
