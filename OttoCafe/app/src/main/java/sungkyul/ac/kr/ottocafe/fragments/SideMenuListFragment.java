...
public class SideMenuListFragment extends Fragment {
    ...
    void getImage() {
        ...
        Call<RepoItem> call = connectService.getSide();
...
//        menuListAdapter.addData(new MenuItem(0, 0, "아이스 아메리카노", "4000", "원두를 갈아 만든 그냥 쓴 커피", "http://14.63.196.255/020cafe_image/blackcoffee.jpg"));
//        menuListAdapter.addData(new MenuItem(1, 1, "카페라떼", "4500", "우유를 타서 부드럽게 마실 수 있는 커피", "http://14.63.196.255/020cafe_image/latte.jpg"));
//        menuListAdapter.addData(new MenuItem(0, 2, "에스프레소", "4000", "유럽식 입맛을 즐기고 싶다면.. 에스프레소", "http://14.63.196.255/020cafe_image/espresso.jpg"));
    }
